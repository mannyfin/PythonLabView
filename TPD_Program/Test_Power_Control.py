"""
This file tests the linear temperature ramp by sending values for the power output to the eurotherm and monitoring
the temperature on the type K thermocouple
